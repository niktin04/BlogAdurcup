...
def generate_dot(graph_data, template='django_extensions/graph_models/digraph.dot'):
    ...
    if not isinstance(t, Template) and not (hasattr(t, 'templates') and isinstance(t.template, Template)):
        raise Exception("Default Django templates loader isn't used. "
                        "This can lead to the incorrect templates rendering. "
